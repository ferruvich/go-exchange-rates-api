...
func TestRepository_CurrentSpecificRates(t *testing.T) {
	currencies := []string{"GBP"}

	t.Run("should return error due to invalid base param", func(t *testing.T) {
		repo := repository.New(nil)
		res, err := repo.CurrentSpecificRates("", []string{})
		assert.Error(t, err)
		assert.Nil(t, res)
		assert.Equal(t, repository.ErrInvalidParam, errors.Cause(err))
	})
	...
	t.Run("should return error due to invalid currency param", func(t *testing.T) {
		repo := repository.New(nil)
		res, err := repo.CurrentSpecificRates(base, []string{})
		assert.Error(t, err)
		assert.Nil(t, res)
		assert.Equal(t, repository.ErrInvalidParam, errors.Cause(err))
	})
	...
	t.Run("should return error due to problem on NewRequest", func(t *testing.T) {
		...
		repo := repository.New(mockHttpService)
		res, err := repo.CurrentSpecificRates(base, currencies)
		assert.Error(t, err)
		assert.Nil(t, res)
		assert.Equal(t, repository.ErrRequest, errors.Cause(err))
	})
...
func TestRepository_HistoricalSpecificRates(t *testing.T) {
	currencies := []string{"GBP"}
	...
	t.Run("should return error due to invalid base param", func(t *testing.T) {
		repo := repository.New(nil)
		res, err := repo.HistoricalSpecificRates("", "", "", []string{})
		assert.Error(t, err)
		assert.Nil(t, res)
		assert.Equal(t, repository.ErrInvalidParam, errors.Cause(err))
	})
	...
	t.Run("should return error due to invalid start param", func(t *testing.T) {
		repo := repository.New(nil)
		res, err := repo.HistoricalSpecificRates(base, "", "", []string{})
		assert.Error(t, err)
		assert.Nil(t, res)
		assert.Equal(t, repository.ErrInvalidParam, errors.Cause(err))
	})
	...
	t.Run("should return error due to invalid end param", func(t *testing.T) {
		repo := repository.New(nil)
		res, err := repo.HistoricalSpecificRates(base, startDate, "", []string{})
		assert.Error(t, err)
		assert.Nil(t, res)
		assert.Equal(t, repository.ErrInvalidParam, errors.Cause(err))
	})

	t.Run("should return error due to invalid currencies param", func(t *testing.T) {
		repo := repository.New(nil)
		res, err := repo.HistoricalSpecificRates(base, startDate, endDate, []string{})
		assert.Error(t, err)
		assert.Nil(t, res)
		assert.Equal(t, repository.ErrInvalidParam, errors.Cause(err))
	})
	...
	t.Run("should return error due to problem on NewRequest", func(t *testing.T) {
		...
		repo := repository.New(mockHttpService)
		res, err := repo.HistoricalSpecificRates(base, startDate, endDate, currencies)
		assert.Error(t, err)
		assert.Nil(t, res)
		assert.Equal(t, repository.ErrRequest, errors.Cause(err))
	})
